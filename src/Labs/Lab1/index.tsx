...
tag to tell browsers to render the gaps.
            ...
            <div id="wd-lists">
                ...
                <div id="wd-images">
                    ...
                    <br />
                    <img src="images/teslabot.png" height="200px"/>
                </div>
                <div id="wd-forms">
                    <h4>Form Elements</h4>
                    <form id="wd-text-fields">
                        ...
                        <br />
                        <label htmlFor="wd-text-fields-password">Passworld:</label>
                        <input type="password" id="wd-text-fields-passworld" value="123@#asad" />
                        <br />
                        <label htmlFor="wd-text-fields-first-name">First name:</label>
                        <input type="text" id="wd-text-fields-first-name" title="john" />
                        <br />
                        <label htmlFor="wd-text-fields-last-name">Last name:</label>
                        <input type="wd-text-fields-last-name" placeholder="Doe"
                    ...
                    <h4>Other HTMK field types</h4>
                    <label htmlFor="wd-text-fields-email"> Email: </label>
                    <input type="email" 
                    placeholder="jdoe@gmail.com" 
                    id="wd-tect-fields-email"/>
                    <br />
